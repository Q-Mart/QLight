...
HD_PWD='/home/userfs/q/qj544/w2k/QLight/proj/HDMI.runs/system_axi_vdma_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_vdma_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_vdma_0_3.tcl
