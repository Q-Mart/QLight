...
set PortName2 "stream_passThrough"
set BitWidth2 "96"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType20 "[list ap_uint 24 ]"
...
set structArgument2 [list 24 1 1 1 ]
set NameSpace2 [list ]
set structIsPacked2 "0"
set DataType2 [list "ap_axiu<24, 1, 1, 1>" "struct ap_axiu" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
