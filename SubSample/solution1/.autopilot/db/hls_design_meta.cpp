...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("stream_in_TDATA", 24, hls_in, 1, "axis", "in_data", 1),
	Port_Property("stream_in_TVALID", 1, hls_in, 7, "axis", "in_vld", 1),
	Port_Property("stream_in_TREADY", 1, hls_out, 7, "axis", "in_acc", 1),
	Port_Property("stream_in_TKEEP", 3, hls_in, 2, "axis", "in_data", 1),
	Port_Property("stream_in_TSTRB", 3, hls_in, 3, "axis", "in_data", 1),
	Port_Property("stream_in_TUSER", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("stream_in_TLAST", 1, hls_in, 5, "axis", "in_data", 1),
	Port_Property("stream_in_TID", 1, hls_in, 6, "axis", "in_data", 1),
	Port_Property("stream_in_TDEST", 1, hls_in, 7, "axis", "in_data", 1),
	Port_Property("stream_process_TDATA", 24, hls_out, 8, "axis", "out_data", 1),
	Port_Property("stream_process_TVALID", 1, hls_out, 14, "axis", "out_vld", 1),
	Port_Property("stream_process_TREADY", 1, hls_in, 14, "axis", "out_acc", 1),
	Port_Property("stream_process_TKEEP", 3, hls_out, 9, "axis", "out_data", 1),
	Port_Property("stream_process_TSTRB", 3, hls_out, 10, "axis", "out_data", 1),
	Port_Property("stream_process_TUSER", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("stream_process_TLAST", 1, hls_out, 12, "axis", "out_data", 1),
	Port_Property("stream_process_TID", 1, hls_out, 13, "axis", "out_data", 1),
	Port_Property("stream_process_TDEST", 1, hls_out, 14, "axis", "out_data", 1),
	...
	Port_Property("s_axi_AXILiteS_r_AWVALID", 1, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_AWREADY", 1, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_AWADDR", 5, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_WVALID", 1, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_WREADY", 1, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_WDATA", 32, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_WSTRB", 4, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_ARVALID", 1, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_ARREADY", 1, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_ARADDR", 5, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_RVALID", 1, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_RREADY", 1, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_RDATA", 32, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_RRESP", 2, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_BVALID", 1, hls_out, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_BREADY", 1, hls_in, -1, "", "", 1),
	Port_Property("s_axi_AXILiteS_r_BRESP", 2, hls_out, -1, "", "", 1),
};
