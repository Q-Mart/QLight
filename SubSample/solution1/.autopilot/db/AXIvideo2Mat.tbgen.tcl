...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1769253", "Max" : "1769253"}
	, {"Name" : "Interval", "Min" : "1769253", "Max" : "1769253"}
]}
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { stream_in_TDATA in_data 0 24 }  { stream_in_TVALID in_vld 0 1 } } }
	...
	AXI_video_strm_V_dest_V { axis {  { stream_in_TREADY in_acc 1 1 }  { stream_in_TDEST in_data 0 1 } } }
