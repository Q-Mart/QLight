...
set Interfaces {
    ap_clk {
        ...
        buses "stream_in stream_process stream_passThrough"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    stream_passThrough {
        type "axi4stream"
        mode "master"
        port_prefix "stream_passThrough"
        has_tready "1"
        ports {
            TDATA 24
            TDEST 1
...
## System Info
set user_parameters_list {clk_period 13.5 machine 64 combinational 0 latency 10613640 II x}
