...
set Library     "hls"
set IPName      "subsamble"
set Version     "1.0"
set DisplayName "SubSampler"
set Revision    "1901281143"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 ram W 0x0 "Data signal of ram" {{0 32 ram W 0 "Bit 31 to 0 Data signal of ram"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_AXILiteS_r {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_AXILiteS_r"
        param_prefix "C_S_AXI_AXILITES_R"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 n W 0x0 "Data signal of n" {{0 32 n W 0 "Bit 31 to 0 Data signal of n"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_AXILiteS_r m_axi_MAXI stream_in stream_process"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 8848606 II x}
