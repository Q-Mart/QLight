...
#ifndef __subsamble_mul_mulbkb__HH__
#define __subsamble_mul_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(subsamble_mul_mulbkb) {
    ...
    SC_CTOR(subsamble_mul_mulbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
