...
architecture rtl of toplevel_visited_ram is 
...
architecture arch of toplevel_visited is
    component toplevel_visited_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    toplevel_visited_ram_U :  component toplevel_visited_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
