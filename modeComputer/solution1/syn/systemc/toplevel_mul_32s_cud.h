...
#ifndef __toplevel_mul_32s_cud__HH__
#define __toplevel_mul_32s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(toplevel_mul_32s_cud) {
    ...
    SC_CTOR(toplevel_mul_32s_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
