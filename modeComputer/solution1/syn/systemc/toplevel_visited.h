...
#ifndef __toplevel_visited_H__
#define __toplevel_visited_H__
...
toplevel_visited_ram* meminst;


SC_CTOR(toplevel_visited) {
meminst = new toplevel_visited_ram("toplevel_visited_ram");
