...
#ifndef __toplevel_mac_mulaeOg__HH__
#define __toplevel_mac_mulaeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(toplevel_mac_mulaeOg) {
    ...
    SC_CTOR(toplevel_mac_mulaeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
