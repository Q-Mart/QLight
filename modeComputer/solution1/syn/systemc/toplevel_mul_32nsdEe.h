...
#ifndef __toplevel_mul_32nsdEe__HH__
#define __toplevel_mul_32nsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(toplevel_mul_32nsdEe) {
    ...
    SC_CTOR(toplevel_mul_32nsdEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
