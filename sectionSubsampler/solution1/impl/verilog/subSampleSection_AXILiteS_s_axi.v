...
`timescale 1ns/1ps
module subSampleSection_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_FACTOR_DATA_0   = 6'h18,
    ADDR_FACTOR_CTRL     = 6'h1c,
    ADDR_LENGTH_R_DATA_0 = 6'h20,
    ADDR_LENGTH_R_CTRL   = 6'h24,
    ADDR_HEIGHT_DATA_0   = 6'h28,
    ADDR_HEIGHT_CTRL     = 6'h2c,
    ADDR_IN_R_DATA_0     = 6'h30,
    ADDR_IN_R_CTRL       = 6'h34,
    ADDR_OUT_R_DATA_0    = 6'h38,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FACTOR_DATA_0: begin
                    rdata <= int_factor[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_FACTOR_DATA_0)
            int_factor[31:0] <= (WDATA[31:0] & wmask) | (int_factor[31:0] & ~wmask);
    end
end
