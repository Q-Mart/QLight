...
void XToplevel_Set_scaledLength(XToplevel *InstancePtr, u32 Data) {
    ...
    XToplevel_WriteReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_SCALEDLENGTH_DATA, Data);
}
...
u32 XToplevel_Get_scaledLength(XToplevel *InstancePtr) {
    ...
    Data = XToplevel_ReadReg(InstancePtr->Axilites_BaseAddress, XTOPLEVEL_AXILITES_ADDR_SCALEDLENGTH_DATA);
    return Data;
}
