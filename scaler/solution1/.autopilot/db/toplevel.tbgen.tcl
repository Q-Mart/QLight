set C_TypeInfoList {{ 
"toplevel" : [[], {"return": [[],"0"] }, [{"ExternC" : 0}], [ {"ram": [[],{ "pointer": "0"}] }, {"length": [[],{ "pointer": "0"}] }, {"height": [[],{ "pointer": "0"}] }, {"scaledLength": [[],{ "pointer": "0"}] }],["1","2"],""],
 "1": [ "sectionDataCopy", [[], {"array": ["0", [108000]]}],""],
 "2": [ "newSectionData", [[], {"array": ["0", [1688]]}],""], 
...
set C_modelArgList {
	...
	{ scaledLength int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "MAXI", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ram","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "ram","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "scaledLength", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "scaledLength","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"in":48}, "offset_end" : {"in":55}} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "109708", "EstimateLatencyMax" : "109708",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "scaledLength", "Type" : "None", "Direction" : "I"},
			{"Name" : "sectionDataCopy", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "newSectionData", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sectionDataCopy_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.newSectionData_U", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.toplevel_mul_64s_dEe_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	toplevel {
		MAXI {Type IO LastRead 14 FirstWrite 15}
		ram {Type I LastRead 0 FirstWrite -1}
		length_r {Type I LastRead 9 FirstWrite -1}
		height {Type I LastRead 9 FirstWrite -1}
		scaledLength {Type I LastRead 15 FirstWrite -1}
		sectionDataCopy {Type IO LastRead -1 FirstWrite -1}
		newSectionData {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "109708", "Max" : "109708"}
	, {"Name" : "Interval", "Min" : "109709", "Max" : "109709"}
]}
