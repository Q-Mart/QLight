...
`timescale 1 ns / 1 ps
module toplevel_newSecticud_ram (addr0, ce0, d0, we0, q0,  clk);
...
initial begin
    $readmemh("./toplevel_newSecticud_ram.dat", ram);
end
        ...
        always @(posedge clk) begin
            if (ce0) begin
                if (we0[i]) begin
                    ...
                    q0[i*COL_WIDTH +: COL_WIDTH] <= d0[i*COL_WIDTH +: COL_WIDTH];
                end
                else
...
toplevel_newSecticud_ram toplevel_newSecticud_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
