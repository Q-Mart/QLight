...
entity toplevel_newSecticud_ram is 
    generic(
...
architecture rtl of toplevel_newSecticud_ram is 
...
entity toplevel_newSecticud is
    generic (
...
architecture arch of toplevel_newSecticud is
    component toplevel_newSecticud_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    toplevel_newSecticud_ram_U :  component toplevel_newSecticud_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
