...
#ifndef __toplevel_mul_64s_dEe__HH__
#define __toplevel_mul_64s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(toplevel_mul_64s_dEe) {
    ...
    SC_CTOR(toplevel_mul_64s_dEe):  ACMP_mul_su_U ("ACMP_mul_su_U") {
