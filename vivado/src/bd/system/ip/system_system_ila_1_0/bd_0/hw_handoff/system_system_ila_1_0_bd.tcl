...
################################################################
# This is a generated script based on design: bd_15e9
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./w2k/QLight/vivado/src/bd/system/ip/system_system_ila_1_0/bd_0
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_VID_IO_active_video_1 [get_bd_ports SLOT_0_VID_IO_active_video] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_VID_IO_data_1 [get_bd_ports SLOT_0_VID_IO_data] [get_bd_pins ila_lib/probe0]
  connect_bd_net -net SLOT_0_VID_IO_hsync_1 [get_bd_ports SLOT_0_VID_IO_hsync] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_VID_IO_vsync_1 [get_bd_ports SLOT_0_VID_IO_vsync] [get_bd_pins ila_lib/probe2]
