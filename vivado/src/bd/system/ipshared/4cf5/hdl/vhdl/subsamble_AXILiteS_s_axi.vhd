...
entity subsamble_AXILiteS_s_axi is
generic (
...
end entity subsamble_AXILiteS_s_axi;
...
architecture behave of subsamble_AXILiteS_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_RAM_DATA_0 : INTEGER := 16#10#;
    constant ADDR_RAM_CTRL   : INTEGER := 16#14#;
