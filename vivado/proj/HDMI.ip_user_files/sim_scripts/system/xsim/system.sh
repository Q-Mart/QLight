...
{
  file="xsim.ini"
  lib_map_path="/opt/york/cs/net/xilinx_vivado-2018.2_ise-14.7_x86-64-1/Vivado/2018.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
