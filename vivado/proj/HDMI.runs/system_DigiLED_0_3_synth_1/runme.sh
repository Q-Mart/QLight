...
HD_PWD='/home/userfs/q/qj544/w2k/QLight/vivado/proj/HDMI.runs/system_DigiLED_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_DigiLED_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_DigiLED_0_3.tcl
