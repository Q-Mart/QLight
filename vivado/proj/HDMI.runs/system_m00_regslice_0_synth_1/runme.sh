...
HD_PWD='/home/userfs/q/qj544/w2k/QLight/vivado/proj/HDMI.runs/system_m00_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_m00_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_m00_regslice_0.tcl
