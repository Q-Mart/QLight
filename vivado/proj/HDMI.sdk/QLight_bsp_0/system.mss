...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = DigiLED
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DigiLED_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = toplevel
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = toplevel_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.2
 PARAMETER HW_INSTANCE = v_tc_in
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.2
 PARAMETER HW_INSTANCE = v_tc_out
END
